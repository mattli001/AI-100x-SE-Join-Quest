...
clean:
	@echo "清理報告檔案..."
	rm -rf task2/test/reports/cucumber-html-report.html
	rm -rf task2/test/reports/cucumber.json
	rm -rf task2-2/test/reports/cucumber-html-report.html
	rm -rf task2-2/test/reports/cucumber.json
	@echo "清理完成"
